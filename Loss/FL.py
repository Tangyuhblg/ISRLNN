...
if __name__ == '__main__':
    ...
    print('*' * 50)
    print('FL Accuracy:%.4f+%.4f' % (np.mean(Acc_list), np.std(Acc_list)))
    print('FL F-measure:%.4f+%.4f'%(np.mean(F_measure_list), np.std(F_measure_list)))
    print('FL G-mean:%.4f+%.4f'%(np.mean(G_mean_list), np.std(G_mean_list)))
    print('FL MCC:%.4f+%.4f'%(np.mean(MCC_list), np.std(MCC_list)))
    print('FL AUC:%.4f+%.4f'%(np.mean(AUC_list), np.std(AUC_list)))
    print('FL FPR:%.4f+%.4f'%(np.mean(FPR_list), np.std(FPR_list)))
    print('FL FNR:%.4f+%.4f'%(np.mean(FNR_list), np.std(FNR_list)))
