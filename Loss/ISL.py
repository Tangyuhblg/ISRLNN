...
if __name__ == '__main__':
    ...
    print('*' * 50)
    print('ISL Accuracy:%.4f+%.4f' % (np.mean(Acc_list), np.std(Acc_list)))
    print('ISL F-measure:%.4f+%.4f' % (np.mean(Acc_list), np.std(Acc_list)))
    print('ISL F-measure:%.4f+%.4f'%(np.mean(F_measure_list), np.std(F_measure_list)))
    print('ISL G-mean:%.4f+%.4f'%(np.mean(G_mean_list), np.std(G_mean_list)))
    print('ISL MCC:%.4f+%.4f'%(np.mean(MCC_list), np.std(MCC_list)))
    print('ISL AUC:%.4f+%.4f'%(np.mean(AUC_list), np.std(AUC_list)))
    print('ISL FPR:%.4f+%.4f'%(np.mean(FPR_list), np.std(FPR_list)))
    print('ISL FNR:%.4f+%.4f'%(np.mean(FNR_list), np.std(FNR_list)))
